...
void RocksDBClient::run() { 
  if (workload_proxy_->is_load()) {
    ...
    leveldb::Status s = leveldb::DB::Open(options2, data_dir_, &db_);*/
#if OFFLINE_LEARNING
		std::cout << "WaitForBackground()\n";
