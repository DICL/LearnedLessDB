...
//#include "leveldb/utilities/options_util.h"
//#include "leveldb/utilities/transaction_db.h"
//#include "leveldb/iostats_context.h"
//#include "leveldb/perf_context.h"
//#include "leveldb/utilities/transaction.h"
//#include "leveldb/merge_operator.h"
#include "hyperleveldb/slice.h"
//#include "leveldb/metadata.h"
...
#define ERR(expr) do{leveldb::Status ec = (expr); if(!ec.ok()) fprintf(stderr,  \
...
//#endif
    ...
    std::atomic<bool> stop_;
		...
		/*std::vector<leveldb::LiveFileMetaData>  GetMetadata(std::string dir){
			leveldb::DB* db;
			leveldb::Options options;
			ERR(leveldb::DB::Open(options, dir, &db));
			std::vector<leveldb::LiveFileMetaData> metadata;
