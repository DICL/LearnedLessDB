...
void MemTable::Add(SequenceNumber s, ValueType type,
  ...
  table_.Insert(buf);
  //if (key_size != 16 || val_size != 8 || internal_key_size != 24 || encoded_len != 34) {
  if (key_size != 16 || internal_key_size != 24) {
	  fprintf(stdout, "key_size: %lu, val_size: %lu, internal_key_size: %lu, encoded_len: %lu\n",
						key_size, val_size, internal_key_size, encoded_len);
	}
}
